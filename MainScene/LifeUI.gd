...
func show_message(text):
	get_node("stageMessage").set_text(text)
	get_node("stageMessage").show()
	get_node("stageMessageTimer").start()
	
func _on_stageMessageTimer_timeout():
	get_node("stageMessage").hide()
